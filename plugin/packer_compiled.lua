...
_G.packer_plugins = {
  ...
  ["nvim-lint"] = {
    loaded = true,
    path = "/Users/kiril.vodenicharov/.local/share/nvim/site/pack/packer/start/nvim-lint",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/kiril.vodenicharov/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["vim-devicons"] = {
    loaded = true,
    path = "/Users/kiril.vodenicharov/.local/share/nvim/site/pack/packer/start/vim-devicons",
